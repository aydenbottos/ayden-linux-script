...
echo -e "deb http://us.archive.ubuntu.com/ubuntu/ $nickname main restricted universe multiverse$(printf '\n')deb http://us.archive.ubuntu.com/ubuntu/ $nickname-security main restricted universe multiverse$(printf '\n')deb http://us.archive.ubuntu.com/ubuntu/ $nickname-updates main restricted universe multiverse$(printf '\n')deb http://us.archive.ubuntu.com/ubuntu/ $nickname-proposed main restricted universe multiverse$(printf '\n')deb-src http://us.archive.ubuntu.com/ubuntu/ $nickname main restricted universe multiverse$(printf '\n')deb-src http://us.archive.ubuntu.com/ubuntu/ $nickname-security main restricted universe multiverse$(printf '\n')deb-src http://us.archive.ubuntu.com/ubuntu/ $nickname-updates main restricted universe multiverse$(printf '\n')deb-src http://us.archive.ubuntu.com/ubuntu/ $nickname-proposed main restricted universe multiverse" > /etc/apt/sources.list
