echo "Made by Ellie"
@ECHO OFF
set functions=checkFiles firewall lsp audit usrRights services winFeatures registry checkUsr misc netShare flushDNS defAccounts passwords rdp installMalwarebytes installAVG installMBAnti installMBSA installRevo installSUPER lockdown tools verifySysS
...
set /P password="What do you want their password to be? "
...
if "%answer%"=="yes" goto : AddingNewUser
